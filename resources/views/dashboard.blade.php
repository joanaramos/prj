  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-share"></i> <span>Aeronaves</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i> Adicionar Aeronave</a></li>
            <li>
            ...
            <li><a href="#"><i class="fa fa-circle-o"></i>Consultar Aeronaves</a></li>
          </ul>
        </li>
        @endif
